...
<form action="" name="topForm1" method="post">
	<table>
		...
		<tbody>
			<tr>
				<td class="col1">질문번호</td>
				<td class="col2">
					<input type="text" name="noti_no" class="chk1" readonly="readonly" value="${notice.noti_no}">
				</td>
			</tr>
			<tr>
				<td class="col1">제목</td>
		...
		<tfoot>
			<tr>
				<td colspan="3">
					<button type="button" onclick="location.href='/notice'">Q&A 목록</button>
				</td>
			</tr>
		</tfoot>
	</table>
