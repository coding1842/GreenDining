...
<body>
  <div style="text-align: center">
    ...
    <div class="fingForm" id="user_find">
      ...
      <button class="fingBtn" onclick="location.href='/auth/find-pw/phone'">
      ...
      <button class="fingBtn" onclick="location.href='/auth/find-pw/email'">
      ...
      <p id="searchA"><a href="/auth/find-id">아이디 찾기</a></p>
      <div id="backCol">
    ...
    <div class="fingForm" id="business_find" style="display: none">
      ...
      <button class="fingBtn" onclick="location.href='/auth/find-pw/business'">
        <i class="fa-solid fa-mobile-screen-button" style="color: #182e15"></i>
        사업자등록 번호로 찾기
        <div class="fBtnI"><i class="fa-solid fa-chevron-right" style="color: #182e15"></i></div>
      </button>
