...
<body>
  <div style="text-align: center">
    ...
    <div class="fingForm" id="user_find">
      ...
      <p id="middleTit">아이디를 잊으셨나요?</p>
      <p id="pickHow">원하시는 방법을 선택해주세요</p>

      <button class="fingBtn" onclick="location.href='/auth/find-id/phone'">
      ...
      <button class="fingBtn" onclick="location.href='/auth/find-id/email'">
        <i class="fa-regular fa-envelope" style="color: #182e15"></i>
        이메일 주소로 찾기
        <div class="fBtnI"><i class="fa-solid fa-chevron-right" style="color: #182e15"></i></div>
      </button>

      <p id="smallTit">비밀번호를 잊으셨나요?</p>
      <p id="searchA"><a href="/auth/find-pw">비밀번호 찾기</a></p>
      <div id="backCol">
    ...
    <div class="fingForm" id="business_find" style="display: none">
      ...
      <button class="fingBtn" onclick="location.href='/auth/find-id/business'">
        <i class="fa-solid fa-mobile-screen-button" style="color: #182e15"></i>
        사업자등록 번호로 찾기
        <div class="fBtnI"><i class="fa-solid fa-chevron-right" style="color: #182e15"></i></div>
      </button>
