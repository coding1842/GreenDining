...
<html>
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="/css/smartstore/view/SaleItemList.css" />
    <!-- JS -->
  ...
  <body>
    <div id="All_product_list">
      <!-- top 배너 -->
      <div class="banner">
        <img alt="" src="/image/today_best_banner.png" style="width: 88.5rem; height: 20rem; margin-bottom: 30px" />
      </div>
      <!-- 전체상품 리스트 -->
      <p style="text-align: center; font-size: 30px; font-weight: bold">전체 상품</p>
      <div class="sortlist">
        <ul>
