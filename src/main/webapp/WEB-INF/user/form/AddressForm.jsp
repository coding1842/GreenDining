...
<body>
	<div id="green-delivery">
		...
		<form action="/user/insertAddress" name="deliveryForm1" enctype="mutipart/form-data" method="post">
			<table>	
				...
				<tr>
					...
					<td style="display: flex;">
						<input type="text" name="zipcode" class="add" readonly="readonly"
				...
				<tr>
					<th>주소</th>
					<td>
						<input type="text" name="address" class="add" readonly="readonly"
